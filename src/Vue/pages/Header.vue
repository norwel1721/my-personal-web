  ...
  <header id="home" class="bg">
    <nav class="navbar navbar-expand-lg fixed-top dark-bg">
      <a class="navbar-brand" href="#">
        <div v-if="main.logo"><img src="../../assets/images/norz.png" alt="logo" id="Logo"></div>
        <div v-if="!main.logo">
      ...
      <div id="navbarNavAltMarkup" class="collapse navbar-collapse">
        <ul id="navbar-nav" class="navbar-nav ml-auto">
          ...
          <li><a class="nav-item nav-link" href="#skills">Experience And Skills</a></li>
          <li><a class="nav-item nav-link" href="#portfolio">WORKS</a></li>
